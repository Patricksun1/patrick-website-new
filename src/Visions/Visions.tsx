    ...
    <div className="visions" id="visions">
      ...
      <div className="visions-container">
        ...
        <ul>
            ...
            international student, pride and postgrad events) by working closely
            with other ports and societies.
          </li>
          <li>
          ...
          <li>
            ...
            experience (e.g. internships, work placements, industry projects) by
            promoting available opportunities and facilitating connections with
            employers.{" "}
          </li>
          <li>
          ...
          <li>
            ...
            prioritizing spending on initiatives that provide the most value to
            members.
          </li>
          <li>
            Increase revenue streams by exploring new fundraising
            opportunities, seeking out sponsorships, and promoting CSESoc events
